...
DISCLAIMER = (
    "미리 정해둔 가격 규칙이 지금 어느 구간이라고 말하는지를 그대로 보여줍니다. "
    "사람의 판단이 들어가지 않고, 규칙과 그 규칙의 과거 성적을 화면에 함께 공개합니다. "
    "데이터 출처는 Yahoo Finance 이며 지연·오류가 있을 수 있습니다. "
...
SIGNAL_LEVELS = [
    "손절선은 50일 평균선이에요. 이 아래로 내려오면 규칙이 청산이라고 말해요",
